      ...
      <NavLink to={"/"}>
       ...
       <li className="mx-5 text-lg"><NavLink to={'/premium'} className={({isActive}) => isActive ? isActiveStyles : isNotActiveStyles} >Premium</NavLink></li>
        ...
        <img src={user?.user?.imageURL}
          className="w-12 min-w-[44px] object-cover rounded-full shadow-lg" alt='' referrerpolicy="no-referrer"></img>
          ...
          className="absolute z-10 top-12 right-0 w-275 p-4 gap-4 bg-card shadow-lg rounded-lg backdrop-blur-sm flex flex-col">
            ...
            <hr/>
                 ...
                 <p
              className="text-base text-textColor hover:font-semibold duration-150 transition-all ease-in-out" onClick={logout}>
              Sign out
            </p>
            </motion.div>
          )}
